...
interface RotatingTeddyBearProps {
  rotationValue: number;
  isAnimating: boolean;
}

const RotatingTeddyBear: React.FC<RotatingTeddyBearProps> = ({ rotationValue, isAnimating }) => {
  const rotation = Math.abs(rotationValue) * 10;
...
export default RotatingTeddyBear;
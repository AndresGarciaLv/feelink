...
<ButtonWrapper>
  <Button title="Home Tutor" onPress={() => navigation.navigate('HomeTutor')} />
</ButtonWrapper>
...
<ButtonWrapper>
  <Button title="Ir al dashboard" onPress={() => navigation.navigate('Dashboard')} />
</ButtonWrapper>

<ButtonWrapper>
  <Button title="BLUETOOTH SCREEN" onPress={() => navigation.navigate('Bluetooth')} />
</ButtonWrapper>
...
<ButtonWrapper>
  <Button
    ...
    onPress={() =>
      navigation.navigate('Wifi1', {
        device: { id: 'mock', name: 'Dispositivo Mock' },
      })
    }
  />
</ButtonWrapper>
